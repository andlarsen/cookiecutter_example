...
- `src/cookiecutter_example/` package with CLI (Typer + Rich), py.typed marker
...
[@andlarsen](https://github.com/andlarsen) (Andreas Larsen) created cookiecutter_example.
