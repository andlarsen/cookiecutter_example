...
If you find a security vulnerability in cookiecutter_example, please report it through [GitHub's private vulnerability reporting](https://github.com/andlarsen/cookiecutter_example/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact dreaslarsen93@gmail.com for details.
